...
\usepackage{babel}
\begin{document}
\materia{Electr\'onica III}
\titulo{Trabajo de Laboratorio $N^{\circ}$ 2}
\fecha{18 de Octubre de 2018} %Aca va la fecha. Si lo dejan asi muestra la fecha de compilacion.
\grupo{7}
...
\begin{center}
\includegraphics[width=10cm]{LogoItba}\\
